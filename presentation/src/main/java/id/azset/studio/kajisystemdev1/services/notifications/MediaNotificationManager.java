package id.azset.studio.kajisystemdev1.services.notifications;
...
import id.azset.studio.kajisystemdev1.services.MusicService;
...
public class MediaNotificationManager {
    ...
    private PendingIntent createContentIntent() {
        Intent openUI = new Intent(mService, FullScreenPlayer.class);
